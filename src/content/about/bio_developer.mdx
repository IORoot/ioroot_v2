...
Developer and Lead **DevOps Engineer** at [ThirtyThreeGlobal](https://www.ThirtyThreeGlobal.com). I run my own company [LondonParkour](https://LondonParkour.com), build websites, infrastucture and services.
...
The sidebar on the left lists my work experience in chronological order. Click the button to see more about that role.
