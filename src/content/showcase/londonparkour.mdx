...
If you head over to the [projects section](/projects) and filter by 'wordpress-plugin' you'll see **most** of the plugins installed on the LondParkour.com website available. Make sure you check both public and archived.
As I build more plugins they are usually added to my github repositories and will be listed there and in the projects.