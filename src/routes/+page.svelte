	...
	<div class="h-screen p-4 md:p-8 pt-20">
		<div class="h-full grid grid-cols-12 grid-rows-8 gap-4 md:gap-6 w-full" bind:this={gridContainer}>
			...
			<div class="col-span-6 md:col-span-8 row-span-4 bg-gradient-to-br from-white to-[#EAE6D8] rounded-3xl shadow-xl p-8 flex flex-col justify-center relative overflow-hidden" style="background-image: url('/images/bento/hero-bg.jpg'), url('/images/bento/hero-bg.svg'); background-size: cover; background-position: center;">
				...
				<div class="text-center relative z-10">
					<h1 class="text-4xl-vh md:text-6xl-vh font-black text-[#434840] {isShortScreen ? 'mb-4' : 'mb-8'}">
						Andy Pearson
					</h1>
					<p class="text-xl-vh md:text-2xl-vh font-black text-[#87A7AC] {isShortScreen ? 'mb-4' : 'mb-8'}">
			...
			<a href="/projects" class="col-span-6 md:col-span-4 bg-gradient-to-br from-[#E7A97F] to-[#E7A97F] rounded-3xl shadow-xl p-6 flex flex-col justify-start text-white relative overflow-hidden" style="grid-row: span {isShortScreen ? 3 : 2};" on:mouseenter={(e) => { e.currentTarget.querySelector('video')?.play(); const video = e.currentTarget.querySelector('video'); if (video) video.style.transform = 'scale(1.1)'; }} on:mouseleave={(e) => { e.currentTarget.querySelector('video')?.pause(); const video = e.currentTarget.querySelector('video'); if (video) video.style.transform = 'scale(1)'; }}>
				<!-- Video Background -->
			...
			<a href="/showcase" class="col-span-6 md:col-span-4 bg-gradient-to-br from-[#EAE6D8] to-[#EAE6D8] rounded-3xl shadow-xl p-6 flex flex-col justify-start text-[#434840] relative overflow-hidden" style="grid-row: span {isShortScreen ? 3 : 2};" on:mouseenter={(e) => { e.currentTarget.querySelector('video')?.play(); const video = e.currentTarget.querySelector('video'); if (video) video.style.transform = 'scale(1.1)'; }} on:mouseleave={(e) => { e.currentTarget.querySelector('video')?.pause(); const video = e.currentTarget.querySelector('video'); if (video) video.style.transform = 'scale(1)'; }}>
				<!-- Video Background -->
				<video class="absolute bottom-0 left-0 w-full h-full object-cover rounded-3xl transition-transform duration-500 ease-out" muted loop playsinline style="min-width: 100%; min-height: 100%; width: auto; height: auto;">
