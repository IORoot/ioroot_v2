...
<div class="min-h-screen bg-[#EAE6D8]">
	...
	<div class="h-screen p-4 md:p-8">
		<div class="h-full grid grid-cols-12 grid-rows-8 gap-4 md:gap-6 w-full" bind:this={gridContainer}>
			...
			<div class="hidden md:block col-span-6 md:col-span-4 row-span-4 rounded-xl md:rounded-3xl shadow-xl p-8 flex flex-col justify-center relative overflow-hidden" style="background-color: #1a1a1a;" bind:this={logoContainer} on:mouseenter={animateLogo}>
				<!-- Film Grain Overlay -->
			...
			<div class="col-span-12 md:col-span-8 row-span-4 bg-gradient-to-br from-white to-[#EAE6D8] rounded-xl md:rounded-3xl shadow-xl p-8 flex flex-col justify-center relative overflow-hidden" style="background-image: url('/images/bento/hero-bg.jpg'), url('/images/bento/hero-bg.svg'); background-size: cover; background-position: center;">
				<!-- Film Grain Overlay -->
			...
			<a href="mailto:{contactInfo.email}" class="col-span-2 md:col-span-2 row-span-2 bg-gradient-to-br from-[#E7A97F] to-[#E7A97F] rounded-xl md:rounded-3xl px-1 py-2 md:p-6 shadow-xl flex flex-col items-center justify-center text-white">
				<svg bind:this={emailIcon} on:mouseenter={animateEmail} class="w-8 h-8 md:w-24 md:h-24" fill="currentColor" viewBox="0 0 24 24">
					<path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
				</svg>
			</a>
			
			<!-- GitHub Contact - Spans 2 columns, 2 rows -->
			<a href={contactInfo.github} target="_blank" rel="noopener noreferrer" class="col-span-2 md:col-span-2 row-span-2 bg-gradient-to-br from-[#677A67] to-[#677A67] rounded-xl md:rounded-3xl px-1 py-2 md:p-6 shadow-xl flex flex-col items-center justify-center text-white">
				<svg bind:this={githubIcon} on:mouseenter={animateGitHub} class="w-8 h-8 md:w-24 md:h-24" fill="currentColor" viewBox="0 0 24 24">
			...
			<a href={contactInfo.linkedin} target="_blank" rel="noopener noreferrer" class="col-span-2 md:col-span-2 row-span-2 bg-gradient-to-br from-[#87A7AC] to-[#87A7AC] rounded-xl md:rounded-3xl px-1 py-2 md:p-6 shadow-xl flex flex-col items-center justify-center text-white">
				<svg bind:this={linkedinIcon} on:mouseenter={animateLinkedIn} class="w-8 h-8 md:w-24 md:h-24" fill="currentColor" viewBox="0 0 24 24">
