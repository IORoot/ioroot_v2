	...
	let interactiveObjects: InteractiveObject[] = [
		{
			...
			height: 16,
			label: 'Resume',
			action: () => window.open('https://example.com/resume', '_blank')
		},
		{
			id: 'linkedin',
			x: 45,
			...
			height: 16,
			label: 'LinkedIn',
			action: () => window.open('https://linkedin.com/in/example', '_blank')
		},
		{
			id: 'github',
			x: 60,
			...
			height: 16,
			label: 'GitHub',
			action: () => window.open('https://github.com/example', '_blank')
		},
		{
			id: 'back',
			x: 5,
...
<div class="game-container">
	...
	<div class="scumm-menu">
		<div class="menu-bar">
			...
			<button class="menu-item active" aria-label="Current page - About">About</button>
		</div>
		
		<div class="inventory-area">
			<div class="text-white text-sm">About Me - Click on links to learn more</div>
		</div>
