			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 w-full">
				{#each filteredRepos as repo}
					...
					<a href="/projects/{repo.name}" class="group block">
						<div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-[#E4EDEE]">
							<!-- Project Image -->
							<div class="aspect-video bg-[#E4EDEE]">
								{#if firstImage}
									<img 
										src={firstImage} 
							...
							<div class="p-4 space-y-3">
								...
								<!-- Tags -->
								<div class="flex flex-wrap gap-1 h-8">
									{#if repo.tags.length > 0}
										...
										{/if}
									{:else}
										<span class="px-3 py-1 bg-transparent text-transparent text-sm rounded-full">
											&nbsp;
										</span>
									{/if}
								</div>
								...
								<!-- Links and Stats -->
								<div class="flex items-center justify-between pt-2 border-t border-[#E4EDEE]">
									<div class="flex items-center space-x-3">
										<a 
											href={repo.html_url} 
											target="_blank" 
											rel="noopener noreferrer"
											class="flex items-center space-x-1 text-[#677A67] hover:text-[#E7897F] transition-colors"
									...
									<!-- Stats -->
									<div class="flex items-center space-x-3 text-sm text-[#677A67] font-semibold">
