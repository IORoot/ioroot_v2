	...
	const websites = [
		{
			...
			image: '/images/londonparkour.jpg',
		...
		},
		{
			...
			description: 'Interactive platform for creating and sharing house hunting challenges and adventures.',
			url: 'https://housequests.com',
			image: '/images/housequests.jpg',
